...
"${TOOLS_DIR}/godot" --headless --path "${PWD}" --export-release "Web" "dist/cavaleiro-canonical-visual-v02.html"
...
mv dist/cavaleiro-canonical-visual-v02.html dist/index.html
...
test -f dist/cavaleiro-canonical-visual-v02.js
test -f dist/cavaleiro-canonical-visual-v02.wasm
test -f dist/cavaleiro-canonical-visual-v02.pck
