...
"${TOOLS_DIR}/godot" --headless --path "${PWD}" --export-release "Web" "dist/cavaleiro-sprint11b-v01.html"
...
mv dist/cavaleiro-sprint11b-v01.html dist/index.html

test -f dist/index.html
test -f dist/cavaleiro-sprint11b-v01.js
test -f dist/cavaleiro-sprint11b-v01.wasm
test -f dist/cavaleiro-sprint11b-v01.pck
