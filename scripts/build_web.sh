...
"${TOOLS_DIR}/godot" --headless --path "${PWD}" --export-release "Web" "dist/reception-playtest-v01.html"
...
mv dist/reception-playtest-v01.html dist/index.html

test -f dist/index.html
test -f dist/reception-playtest-v01.js
test -f dist/reception-playtest-v01.wasm
test -f dist/reception-playtest-v01.pck
